    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom v-if="skuInfo.skuImageList"
            ...
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList"
                ...
                <dd changepirce="0"
                    ...
                    :key="spuSale.id"
                    @click="attrSaleValueClick(spuSaleAttr.spuSaleAttrValueList,spuSale)">{{ spuSale.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
export default {
  ...
  methods: {
    // 售卖详细信息按钮选择
    attrSaleValueClick(spuSaleArray, spuSale) {
      for (let i = 0; i < spuSaleArray.length; i++) {
        spuSaleArray[i].isChecked = 0
      }
      spuSale.isChecked = 1
    },
    // 表单元素修改产品个数
